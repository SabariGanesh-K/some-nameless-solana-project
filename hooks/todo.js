...
export function useTodo() {
    ...
    return { initialized,addTodo, initializeStaticUser,markTodo, loading, transactionPending,removeTodo, completedTodos, incompleteTodos, markStaticTodo, removeStaticTodo, addStaticTodo, input, setInput, handleChange,initializeUser }
}
